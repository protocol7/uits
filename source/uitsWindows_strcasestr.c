 ...
 *
 *  The UITS project uses the strcasestr() function, however this function is not included with
 *  the MinGW compiler. In the interests of time, include the source for this function for
